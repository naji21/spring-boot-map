...
( function() {
	 ...
	 * // njMap에 WMS 레이어 추가
	 * njMap.addWMSLayer( {
	 * 	uWMSLayer : new naji.layer.njMapWMSLayer( {...} )
	 * 	...
	 * } );
	 * </pre>
	 * 
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uWMSLayer {naji.layer.njMapWMSLayer} {@link naji.layer.njMapWMSLayer} 객체.
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uWFSLayer {naji.layer.njMapWFSLayer} {@link naji.layer.njMapWFSLayer} 객체.
	 * @param opt_options.useExtent {Boolean} 레이어 추가 후 extent 설정 사용 여부.
	 * 
	 * `true`면 해당 레이어의 영역으로 지도 영역을 맞춘다. Default is `false`.
	 * 
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uWCSLayer {naji.layer.njMapWCSLayer} {@link naji.layer.njMapWCSLayer} 객체.
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uGSSWMTSLayer {naji.layer.njMapWMSLayer} {@link naji.layer.njMapGSSWMTSLayer} 객체.
	 * @param opt_options.extent {Array.<Number>} 레이어 추가 후 설정될 extent.
	 * @param opt_options.resolution {Float} 레이어 추가 후 설정될 resolution.
	 * @param opt_options.useExtent {Boolean} 레이어 추가 후 extent 설정 사용 여부.
	 * 
	...
	naji.njMap.prototype.addGSSWMTSLayer = function(opt_options) {
		...
		var uGSSWMTSLayer = ( options.uGSSWMTSLayer !== undefined ) ? options.uGSSWMTSLayer : undefined;
		var useExtent = ( options.useExtent !== undefined ) ? options.useExtent : false;
		var extent = ( options.extent !== undefined ) ? options.extent : undefined;
		var resolution = ( options.resolution !== undefined ) ? options.resolution : undefined;
		...
		try {
			_self.olMap.addLayer( uGSSWMTSLayer.getOlLayer() );
			_self.layers.push( uGSSWMTSLayer );

			var source = uGSSWMTSLayer.getOlLayer().getSource();
			source.on( [ "imageloadstart", "tileloadstart" ], function(evt) {
				if ( naji.njMapConfig.isUseLoading() ) {
					naji.njMapConfig.loading( _self.dataViewId, true );
				}
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uWMTSLayer {naji.layer.njMapWMTSLayer} {@link naji.layer.njMapWMTSLayer} 객체.
	 * @param opt_options.extent {Array.<Number>} 레이어 추가 후 설정될 extent.
	 * @param opt_options.useExtent {Boolean} 레이어 추가 후 extent 설정 사용 여부.
	 * 
	 * `true`면 해당 레이어의 영역으로 지도 영역을 맞춘다. Default is `false`.
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uVectorLayer {naji.layer.njMapVectorLayer} {@link naji.layer.njMapVectorLayer} 객체.
	 * @param opt_options.useExtent {Boolean} 레이어 추가 후 extent 설정 사용 여부.
	 * 
	 * `true`면 해당 레이어의 영역으로 지도 영역을 맞춘다. Default is `false`.
	 * 
	 ...
	 * 
	 * @param opt_options {Object}
	 * @param opt_options.uVector3DLayer {naji.layer.njMapVector3DLayer} {@link naji.layer.njMapVector3DLayer} 객체.
	 * @param opt_options.useExtent {Boolean} 레이어 추가 후 extent 설정 사용 여부.
	 * 
	 * `true`면 해당 레이어의 영역으로 지도 영역을 맞춘다. Default is `false`.
	 * 
...
( function() {
	 ...
	 * 	uWMTSLayer : new naji.layer.njMapWMTSLayer({...}),
	...
	naji.baseMap.njMapBaseMapCustom = ( function(opt_options) {
		...
		( function() {
			...
			if ( !_self.uWMTSLayer ) {
				naji.njMapConfig.alert_Error( "uWMTSLayer undefined" );
				_self.isAvailable = false;
				return false;
			}
